    ...
    const csvStream = csv
      ...
      .on('data', async datas => {
        const _data = {
          ...
          zip: true,
          data: [
            { type: 'text', text: datas[0], size: 44, top: 1415, left: 1600 },
            { type: 'text', text: datas[1], size: 44, top: 1500, left: 1600 },
            { type: 'text', text: datas[2], size: 44, top: 1580, left: 1600 },
            { type: 'text', text: datas[3], size: 44, top: 1670, left: 1600 },
            { type: 'text', text: datas[4], size: 44, top: 1750, left: 1600 },
            { type: 'text', text: datas[5], size: 44, top: 1840, left: 1750 },
            { type: 'text', text: datas[6], size: 44, top: 1920, left: 1600 },
            ...
            { type: 'text', text: datas[12], size: 44, top: 2430, left: 1600 },
            { type: 'text', text: datas[13], size: 44, top: 2520, left: 1600 },
            { type: 'text', text: datas[14], size: 44, top: 2600, left: 1600 },
            { type: 'text', text: datas[15], size: 44, top: 2695, left: 1600 },
            ...
            { type: 'text', text: `No.:${datas[20]}`, size: 44, top: 2690, left: 750, rotate: true },
          ],
        };
